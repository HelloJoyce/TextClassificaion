...
model_name = 'Bert'
save_path = root_path + '/src/model/bert_wo_cls.pt'
...
fast_path = root_path + '/src/model/fast.bin'
w2v_path = root_path + '/src/model/w2v.bin'
