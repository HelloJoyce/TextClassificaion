...
from transformers import (WEIGHTS_NAME, AdamW, BertConfig, BertForSequenceClassification,
                          BertTokenizer, RobertaConfig, RobertaForSequenceClassification,
                          RobertaTokenizer, XLNetConfig, XLNetForSequenceClassification,
...
parse.add_argument('--model',
                   type=str,
                   default='BERT',
                   help='选择模型: CNN, RNN, RCNN, RNN_Att, DPCNN, Transformer')
